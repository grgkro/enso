...
class EmailAuthRegistrationForm extends StatefulWidget {
  EmailAuthRegistrationForm({Key? key}) : super(key: key);

  @override
  _EmailAuthRegistrationFormState createState() => _EmailAuthRegistrationFormState();
}

class _EmailAuthRegistrationFormState extends State<EmailAuthRegistrationForm> {
